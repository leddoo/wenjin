...
opcodes = [
    ...
    ["unreachable",             [0x00],         [],                 [],                     ["!"],      ["#", "!"]  ],
    ["nop",                     [0x01],         [],                 [],                     [],         []          ],
    ["block",                   [0x02],         ["block_ty"],       [],                     [],         ["b"]       ],
    ["loop",                    [0x03],         ["block_ty"],       [],                     [],         ["b"]       ],
    ["if",                      [0x04],         ["block_ty"],       [],                     [],         ["b"]       ],
    ["else",                    [0x05],         [],                 [],                     [],         ["b"]       ],
    ["end",                     [0x0b],         [],                 [],                     [],         ["b"]       ],
    ["br",                      [0x0c],         ["label"],          [],                     ["!"],      ["j", "!"]  ],
    ["br_if",                   [0x0d],         ["label"],          ["i32"],                [],         ["j"]       ],
    ["br_table",                [0x0e],         ["br_table"],       ["i32"],                ["!"],      ["j", "!"]  ],
    ["return",                  [0x0f],         [],                 ["rets"],               ["!"],      ["r", "!"]  ],
    ["call",                    [0x10],         ["func"],           ["args"],               ["rets"],   ["c"]       ],
    ["call_indirect",           [0x11],         ["func", "tab"],    ["i32", "args"],        ["rets"],   ["c", "#"]  ],
    ["drop",                    [0x1a],         [],                 ["any"],                [],         []          ],
    ["select",                  [0x1b],         [],                 ["i32", "any", "any"],  ["any"],    []          ],
    ["typed_select",            [0x1c],         ["val_ty"],         ["i32", "any", "any"],  ["any"],    []          ],
    ["local_get",               [0x20],         ["local"],          [],                     ["any"],    []          ],
    ["local_set",               [0x21],         ["local"],          ["any"],                [],         []          ],
    ["local_tee",               [0x22],         ["local"],          ["any"],                ["any"],    []          ],
    ["global_get",              [0x23],         ["global"],         [],                     ["any"],    []          ],
    ["global_set",              [0x24],         ["global"],         ["any"],                [],         []          ],
    ["table_get",               [0x25],         ["table"],          [],                     ["any"],    ["#"]       ],
    ["table_set",               [0x26],         ["table"],          ["any"],                [],         ["#"]       ],
    ["i32_load",                [0x28],         [],                 ["i32"],                ["i32"],    ["#"]       ],
    ["i64_load",                [0x29],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["f32_load",                [0x2A],         [],                 ["i32"],                ["f32"],    ["#"]       ],
    ["f64_load",                [0x2B],         [],                 ["i32"],                ["f64"],    ["#"]       ],
    ["i32_load8_s",             [0x2C],         [],                 ["i32"],                ["i32"],    ["#"]       ],
    ["i32_load8_u",             [0x2D],         [],                 ["i32"],                ["i32"],    ["#"]       ],
    ["i32_load16_s",            [0x2E],         [],                 ["i32"],                ["i32"],    ["#"]       ],
    ["i32_load16_u",            [0x2F],         [],                 ["i32"],                ["i32"],    ["#"]       ],
    ["i64_load8_s",             [0x30],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i64_load8_u",             [0x31],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i64_load16_s",            [0x32],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i64_load16_u",            [0x33],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i64_load32_s",            [0x34],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i64_load32_u",            [0x35],         [],                 ["i32"],                ["i64"],    ["#"]       ],
    ["i32_store",               [0x36],         [],                 ["i32", "i32"],         [],         ["#"]       ],
    ["i64_store",               [0x37],         [],                 ["i32", "i64"],         [],         ["#"]       ],
    ["f32_store",               [0x38],         [],                 ["i32", "f32"],         [],         ["#"]       ],
    ["f64_store",               [0x39],         [],                 ["i32", "f64"],         [],         ["#"]       ],
    ["i32_store8",              [0x3A],         [],                 ["i32", "i32"],         [],         ["#"]       ],
    ["i32_store16",             [0x3B],         [],                 ["i32", "i32"],         [],         ["#"]       ],
    ["i64_store8",              [0x3C],         [],                 ["i32", "i64"],         [],         ["#"]       ],
    ["i64_store16",             [0x3D],         [],                 ["i32", "i64"],         [],         ["#"]       ],
    ["i64_store32",             [0x3E],         [],                 ["i32", "i64"],         [],         ["#"]       ],
    ["memory_size",             [0x3F],         ["memory"],         [],                     ["i32"],    []          ],
    ["memory_grow",             [0x40],         ["memory"],         ["i32"],                ["i32"],    []          ],
    ["i32_const",               [0x41],         ["i32"],            [],                     ["i32"],    []          ],
    ["i64_const",               [0x42],         ["i64"],            [],                     ["i64"],    []          ],
    ["f32_const",               [0x43],         ["f32"],            [],                     ["f32"],    []          ],
    ["f64_const",               [0x44],         ["f64"],            [],                     ["f64"],    []          ],
    ...
    ["ref_null",                [0xd0],         [],                 [],                     ["ref"],    []          ],
    ["ref_is_null",             [0xd1],         [],                 ["ref"],                ["i32"],    []          ],
    ["ref_func",                [0xd2],         ["func"],           [],                     ["ref"],    []          ],

    ["memory_copy",             [0xfc,  10],    ["mem", "mem"],     ["i32", "i32", "i32"],  [],         []          ],
    ["memory_fill",             [0xfc,  11],    ["mem"],            ["i32", "i32", "i32"],  [],         []          ],
]
